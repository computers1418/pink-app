            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Stack(
                    children: [
                      Image.asset("lib/appointments/pages/upcoming_appointment_details/assets/Frame 135.png",),
                      Padding(
                        padding: EdgeInsets.symmetric(
                ...
                Stack(
                  children: [
                    Image.asset("lib/appointments/pages/upcoming_appointment_details/assets/Frame 132.png",),
                    Positioned(top: MediaQuery.of(context).size.height * 0.02,
                      right: MediaQuery.of(context).size.width * 0.055,
                        child: Container(
                          ...
                          decoration: const BoxDecoration(
                            image: DecorationImage(
                              image: AssetImage(
                                  "lib/appointments/pages/upcoming_appointment_details/assets/Rectangle 824.png"
                              )
                            )
                          ),
                          child: Column(
                    ...
                    Positioned(
                      ...
                      child: Stack(
                        children: [
                          SvgPicture.asset("lib/appointments/pages/upcoming_appointment_details/assets/Location.svg",
                            color: Colors.red,
                          ),
                          Padding(
                            padding: EdgeInsets.only(
                              top: MediaQuery.of(context).size.height * 0.0215,
                              left: MediaQuery.of(context).size.width * 0.055,
                            ),
                            child: Image.asset("lib/appointments/pages/upcoming_appointment_details/assets/Frame 1.png",
                              // color: Colors.red,
