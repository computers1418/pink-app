...
import '../search_page_consultation_details/search_page_consultation_details.dart';
import '../settings/settings.dart';

class ConsultationPageConsultationDetails extends StatelessWidget {
  ConsultationPageConsultationDetails({super.key});
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Stack(
                  children: [
                    Image.asset("lib/consultation/pages/search_page_consultation_details/assets/Rectangle 980.png",),
                    Padding(
                      padding: EdgeInsets.symmetric(//bottom: MediaQuery.of(context).size.height * 0.017,
                          horizontal: MediaQuery.of(context).size.width * 0.06
                      ),
              ...
              Padding(
                ...
                child: Stack(
                  children: [
                    Image.asset("lib/consultation/pages/search_page_consultation_details/assets/Rectangle 980-2.png",),
                    Padding(
                      padding: EdgeInsets.symmetric(//bottom: MediaQuery.of(context).size.height * 0.017,
                          horizontal: MediaQuery.of(context).size.width * 0.06,
                      ...
                      child: Column(
                        children: [
                          ...
                          displayCardTextWidget(context, "User ID", "FH234GK65K3", false, false),
